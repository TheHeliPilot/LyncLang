...
#define TOKEN_ALLOC_ERROR (-1)
#define TOKEN_ALLOC_SUCCESS (0)
#define TOKEN_CAPACITY_RESIZE_MULTIPLIER (2)
#define TOKEN_INIT_CAPACITY (20)
#define TOKEN_APPEND_SUCCESS (0)
